...
C     
C     Process: b b~ > mur- mur+ WEIGHTED<=2 / g u c d s u c d s b t b
C      t h01 h2 h3 h+ h+ @1
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $    ABS(mdl_Msl5*small_width_treatment)), mdl_Wsl5)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MB,+1,+1*IC(1),W(1,1)) ! count 4
      CALL IXXXXX(P(0,1),MDL_MB,-1,+1*IC(1),W(1,2)) ! count 4
      CALL OXXXXX(P(0,2),MDL_MB,+1,-1*IC(2),W(1,3)) ! count 4
      CALL OXXXXX(P(0,2),MDL_MB,-1,-1*IC(2),W(1,4)) ! count 4
      CALL SXXXXX(P(0,3),+1*IC(3),W(1,5)) ! count 8
      CALL SXXXXX(P(0,4),+1*IC(4),W(1,6)) ! count 8
      CALL FFV1P0_3(W(1,1),W(1,3),GC_1,ZERO, FK_ZERO,W(1,7)) ! count 1
      CALL FFV1P0_3(W(1,1),W(1,4),GC_1,ZERO, FK_ZERO,W(1,8)) ! count 1
      CALL FFV1P0_3(W(1,2),W(1,3),GC_1,ZERO, FK_ZERO,W(1,9)) ! count 1
      CALL FFV1P0_3(W(1,2),W(1,4),GC_1,ZERO, FK_ZERO,W(1,10)) ! count 1
      CALL VSS1P1N_1(W(1,6), W(1,5), GC_363, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/7,8,9,10/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFV2_5_3(W(1,1),W(1,3),GC_922,GC_923,MDL_MZ, FK_MDL_WZ,W(1,11)) ! count 1
      CALL FFV2_5_3(W(1,1),W(1,4),GC_922,GC_923,MDL_MZ, FK_MDL_WZ,W(1,12)) ! count 1
      CALL FFV2_5_3(W(1,2),W(1,3),GC_922,GC_923,MDL_MZ, FK_MDL_WZ,W(1,13)) ! count 1
      CALL FFV2_5_3(W(1,2),W(1,4),GC_922,GC_923,MDL_MZ, FK_MDL_WZ,W(1,14)) ! count 1
